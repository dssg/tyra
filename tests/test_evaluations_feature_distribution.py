...
def test_get_feature_dist_test():
    with rig_test_client(data) as test_app:
        url = '/evaluations/1/feature_dist_test/arrests_id_p1d_arrestscrimetype_assault_avg/5'
...
def test_get_feature_dist_train():
    with rig_test_client(data) as test_app:
        url = '/evaluations/1/feature_dist_train/arrests_id_p1d_arrestscrimetype_assault_avg/5'
        response = test_app.get(url)
        response_data = json.loads(response.get_data().decode('utf-8'))
